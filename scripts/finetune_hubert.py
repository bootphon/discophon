...
def finetune_hubert(name: str, project: str, workdir: Path, checkpoint: Path, manifest: str) -> None:
...
if __name__ == "__main__":
    ...
    finetune_hubert(args.name, args.project, args.workdir, args.checkpoint, args.manifest)
