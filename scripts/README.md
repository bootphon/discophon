...
2. Get access to [pyannote/segmentation-3.0](https://huggingface.co/pyannote/segmentation-3.0) and export your HuggingFace token to `HF_TOKEN`.
3. Run Voice Activity Detection with pyannote-audio:
   ```bash
