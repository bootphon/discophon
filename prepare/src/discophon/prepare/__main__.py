...
from .core import download_benchmark
from .prepare import prepare_downloaded_benchmark

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    subparsers = parser.add_subparsers(dest="command", required=True, help="command to run")
    parser_download = subparsers.add_parser("download", help="download benchmark data")
    parser_download.add_argument("data", help="path to data directory", type=Path)
    parser_audio = subparsers.add_parser("audio", help="prepare audio files")
